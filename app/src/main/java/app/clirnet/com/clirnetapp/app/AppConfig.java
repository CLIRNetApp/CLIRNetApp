...
public class AppConfig {
    ...
    static final String   LOCAL_DEMO_URL = "http://192.168.1.53/";//49.50.76.125/
    ...
    public static final String URL_SYCHRONISED_TOSERVER = LOCAL_DEMO_URL+"clirnetapplicationv2/public/doctor/webapi/syncpatientdata";
    ...
    public static String UPLOAD_LOGFILE_TOSERVER = LOCAL_DEMO_URL+"clirnetapplicationv2/public/doctor/webapi/logfiles";

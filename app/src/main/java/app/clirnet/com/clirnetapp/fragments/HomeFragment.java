            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (msg.equals("OK")) {
                        ...
                        appController.appendLog(appController.getDateTime() + " " + "/ " + "Home Activity data is sync to server : patient Visit Count : " + patientVisitIdsList + " patient Count : " + patientIds_Listsize);
